public class T03_Media {
    public static void main(String[] args) {
        ...
        //Utilizamos un bucle para leer los datos y otro para
        //Procesarlos se podrian hacer ambas operaciones,
        //leer y procesar, en un solo bucle.
        for (int i = 0; i < 5; i++) {
        ...
        if(cont_neg == 0)
            ...
            System.out.println("La media de los positivos: " + (float)suma_neg/cont_neg);

        System.out.println("La cantidad de 0 es de: "+cont_cero);
    }
}
